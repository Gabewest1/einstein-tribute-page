...
"\nimage4Left:", image4Left)
        ...
        return (
            <SlideManagerContainer>
                <CurrentSlide>
                    <CurrentHeader isAnimating={ this.state.isAnimating }
                        top={ header1Top }
                        left={ header1Left }>This is the first Header Cheddar :D</CurrentHeader>
                    <CurrentContent
                ...
                <NextSlide>
                    <NextHeader
                        isAnimating={ this.state.isAnimating }
                        top={ header2Top }
                        left={ header2Left }>Ayyyy let me slide in here right quick</NextHeader>
                    <NextContent isAnimating={ this.state.isAnimating }
                        top={ content2Top }
                        left={ content2Left }>
